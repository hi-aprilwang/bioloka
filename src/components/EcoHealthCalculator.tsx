        ...
        <div className="mt-6 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium text-zinc-400">kg / hari</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <div className="mt-3">
            ...
            <span className="ml-1.5 text-xs font-bold text-amber-400">kg CH₄</span>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-zinc-800 text-[11px] text-zinc-400 leading-relaxed">
            <span className="text-zinc-300 font-semibold block mb-0.5">
              Efek Eko-Kesehatan:
            </span>
        ...
        >
          ...
          <div className="mt-3">
            ...
            <span className="ml-1.5 text-xs font-bold text-blue-400">Liter Air Lindi</span>
          </div>
          <div className="mt-1 text-xs text-zinc-400">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1 text-xs">
            ...
            <p className="text-zinc-400 leading-relaxed">
              ...
              <code className="text-emerald-300 bg-zinc-900 px-1 py-0.5 rounded font-mono text-[11px]">
