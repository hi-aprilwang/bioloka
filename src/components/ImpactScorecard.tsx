...
export function ImpactScorecard({ impact }: ImpactScorecardProps) {
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <SpotlightCard
        className="p-4 border-zinc-800 bg-zinc-900/60"
      ...
      >
        ...
        <div className="mt-1 flex items-center gap-1 text-[11px] text-zinc-400">
          ...
          <span>Dari 5 titik sentra Semarang</span>
        </div>
      </SpotlightCard>
      ...
      >
        ...
        <div className="mt-3 flex items-baseline gap-1">
          ...
          <span className="text-xs font-semibold text-amber-400">kg CH₄</span>
        </div>
      ...
      >
        ...
        <div className="mt-3 flex items-baseline gap-1">
          ...
          <span className="text-xs font-semibold text-blue-400">Liter</span>
        </div>
        <div className="mt-1 text-[11px] text-zinc-400">
