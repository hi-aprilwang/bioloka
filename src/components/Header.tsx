  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-zinc-200/80 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-950/85 backdrop-blur-md transition-colors">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 sm:px-8 sm:py-5">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <Badge
                variant="outline"
                className="border-emerald-500/30 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 text-sm px-2.5 py-0.5 font-medium tracking-wide"
              >
                DSDC ANFORCOM 2026
              </Badge>
            </div>
        ...
        {/* Navigation Tabs */}
        <nav className="hidden md:flex items-center gap-1 bg-zinc-100 dark:bg-zinc-900/80 p-1.5 rounded-xl border border-zinc-200 dark:border-zinc-800">
          <button
        ...
        <div className="flex items-center gap-3">
          <div className="hidden lg:flex items-center gap-1.5 rounded-full border border-emerald-500/20 bg-emerald-50 dark:bg-emerald-950/30 px-3 py-1 text-sm text-emerald-700 dark:text-emerald-300">
          ...
          <Button
            size="default"
            onClick={onQuickDemo}
            className="h-9 bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-emerald-500/40 text-emerald-800 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-950/50 text-sm gap-1.5 font-medium transition-all shadow-sm"
          >
